...
(function () {
     ...
     */
    var URL;
	URL = window.UEDITOR_HOME_URL="/PortalAdmin/admin/ueditor/";
    /**
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,imagePath:URL + "upload/"                     //鍥剧墖淇鍦板潃锛屽紩鐢ㄤ簡fixedImagePath,濡傛湁鐗规畩闇�眰锛屽彲鑷閰嶇疆
       //,imageFieldName:"upfile"                   //鍥剧墖鏁版嵁鐨刱ey,鑻ユ澶勪慨鏀癸紝闇�鍦ㄥ悗鍙板搴旀枃浠朵慨鏀瑰搴斿弬鏁�
        ...
        ,scrawlPath:URL+"upload/"                            //鍥剧墖淇鍦板潃锛屽悓imagePath

        //闄勪欢涓婁紶閰嶇疆鍖�
        ,fileUrl:URL+"jsp/fileUp.jsp"               //闄勪欢涓婁紶鎻愪氦鍦板潃
        ,filePath:URL + "uploadfiles/"                   //闄勪欢淇鍦板潃锛屽悓imagePath
        ...
        ,catcherPath:URL + "upload/"                  //鍥剧墖淇鍦板潃锛屽悓imagePath
        ...
        ,imageManagerPath:URL + "upload/"                                    //鍥剧墖淇鍦板潃锛屽悓imagePath
        ...
        ,toolbars:[["fullscreen","source","undo","redo","insertunorderedlist","insertorderedlist","unlink","link","cleardoc","selectall","print","searchreplace","preview","separate","help","gmap","pagebreak","insertimage","scrawl","music","snapscreen","emotion","insertvideo","attachment","insertframe","date","time","wordimage","map","webapp","horizontal","anchor","spechars","blockquote","highlightcode","template","background","italic","bold","underline","strikethrough","forecolor","backcolor","superscript","subscript","justifyleft","justifycenter","justifyright","justifyjustify","touppercase","tolowercase","directionalityltr","directionalityrtl","indent","formatmatch","removeformat","autotypeset","pasteplain","customstyle","paragraph","rowspacingbottom","rowspacingtop","fontfamily","lineheight","fontsize","imagenone","imageleft","imagecenter","imageright","inserttable","deletetable","mergeright","mergedown","splittorows","splittocols","splittocells","mergecells","insertcol","insertrow","deletecol","deleterow","insertparagraphbeforetable"]]
...
//           ]
    ...
    //瀛楁暟缁熻鎻愮ず锛寋#count}浠ｈ〃褰撳墠瀛楁暟锛寋#leave}浠ｈ〃杩樺彲浠ヨ緭鍏ュ灏戝瓧绗︽暟,鐣欑┖鏀寔澶氳瑷�嚜鍔ㄥ垏鎹紝鍚﹀垯鎸夋閰嶇疆鏄剧ず
        ...
        //,indentValue:'2em'
        //pageBreakTag
        //鍒嗛〉鏍囪瘑绗�榛樿鏄痏baidu_page_break_tag_
